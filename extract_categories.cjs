...
const startStr = '  function CategoriesPage()';
const nextStr = '  // ── SELL PAGE ──';

const startIdx = content.indexOf(startStr);
const endIdx = content.indexOf(nextStr, startIdx);
...
`;
  ...
  fs.writeFileSync(path.join(__dirname, 'src', 'app', 'pages', 'CategoriesPage.tsx'), imports + compCode, 'utf8');
  console.log("Extracted CategoriesPage successfully.");
}
