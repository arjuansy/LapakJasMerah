...
const file = fs.readFileSync('src/app/pages/ProductDetailPage.tsx', 'utf8');

const startMarker = '<div className="fixed inset-0 z-[60] bg-background overflow-y-auto max-w-[430px] lg:max-w-2xl mx-auto">';
const endMarker = '        {/* ── ORDER CONFIRMATION SHEET ── */}';
...
const newFile = file.slice(0, startIndex) + replacement + '\n' + file.slice(endIndex);

fs.writeFileSync('src/app/pages/ProductDetailPage.tsx', newFile, 'utf8');
