            ...
            <>
              <div className="bg-amber-50 border border-amber-200 p-3.5 rounded-xl mb-4 flex items-start gap-3 text-amber-800 shadow-sm">
                ...
                <p className="text-xs font-semibold leading-relaxed">
                  Fitur registrasi manual dengan OTP saat ini sedang dalam tahap <strong>Uji Coba</strong>. Kami merekomendasikan Anda untuk menggunakan tombol <strong>Daftar dengan Google</strong>.
                </p>
              </div>
