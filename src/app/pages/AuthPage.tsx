          ...
          {!isLogin && (
            <>
              <div className="flex items-center gap-3 mt-6 mb-2">
                ...
                <span className="text-muted-foreground text-[10px] font-bold uppercase tracking-wider">ATAU</span>
                <div className="h-px bg-border flex-1"></div>
              </div>
              ...
              <button
                ...
                className="w-full bg-card border-2 border-border text-foreground font-black py-3.5 rounded-2xl text-sm active:scale-95 transition-all flex justify-center items-center gap-3 hover:bg-muted/50"
              >
